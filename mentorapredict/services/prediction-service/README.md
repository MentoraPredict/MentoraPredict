...
**MentoraPredict MVP Backend** | Port: 3006 | Runtime: Python/FastAPI

## Coverage
RF-019

## Description
ML prediction service: logistic regression risk score + K-means clustering. Anonymized input (RNF-042). Logs to MongoDB (RNF-040).
