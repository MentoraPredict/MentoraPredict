...
FROM (
    ...
    ('11111111-0001-1111-1111-111111111111','Introducción a la Programación','Lógica básica de programación','FP101',4,
     'c5555555-1111-1111-1111-111111111111','aaaaaaaa-2026-1111-1111-111111111111',45,
    ...
    ('33333333-0001-1111-1111-111111111111','Base de Datos I','Modelo relacional y SQL','BD301',4,
     'c5555555-1111-1111-1111-111111111111','aaaaaaaa-2026-1111-1111-111111111111',40,
    ...
    ('99999999-0001-1111-1111-111111111111','Proyecto Integrador I','Desarrollo de proyecto real','PI901',6,
     'c5555555-1111-1111-1111-111111111111','aaaaaaaa-2026-1111-1111-111111111111',30,
     (SELECT id FROM users WHERE role='TEACHER' ORDER BY id LIMIT 1 OFFSET 2),
     TRUE,NOW(),NOW()),
    ...
    ('10101010-0001-1111-1111-111111111111','Proyecto de Titulación','Trabajo final de grado','PT1001',8,
     'c5555555-1111-1111-1111-111111111111','aaaaaaaa-2026-1111-1111-111111111111',25,
     (SELECT id FROM users WHERE role='TEACHER' ORDER BY id LIMIT 1 OFFSET 3),
     TRUE,NOW(),NOW())
