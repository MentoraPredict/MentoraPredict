...
**MentoraPredict MVP Backend** | Port: 3007 | Runtime: NestJS/TypeScript

## Coverage
RF-020, RF-022

## Description
Generates personalized improvement plans via OpenAI GPT. Stores to MongoDB. Teacher observations.
