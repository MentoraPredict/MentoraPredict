...
export class StudentMetricsRepository implements IStudentMetricsRepository {
  ...
  async findByStudentAndPeriod(
    studentId: string,
    periodId: string,
  ): Promise<StudentMetricsEntity | null> {
  ...
  private toOrm(d: StudentMetricsEntity): StudentMetricsOrmEntity {
    ...
    o.subjectAverages = d.subjectAverages;
    o.globalAverage = d.globalAverage;
    o.calculatedAt = d.calculatedAt;
    o.version = d.version;
    return o;
  }
}
