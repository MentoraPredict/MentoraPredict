...
// Kept identical to academic-service's copy (services/academic-service/src/infrastructure/utils/academic-week.util.ts) —
// both services must agree on which (week, year) a given date falls into.
