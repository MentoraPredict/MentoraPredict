...
**MentoraPredict MVP Backend** | Port: 3003 | Runtime: NestJS/TypeScript
...
Academic hierarchy: faculties, careers, periods, subjects, enrollments, evaluations, grades, bulk ingestion.
