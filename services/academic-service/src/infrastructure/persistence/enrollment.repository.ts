...
export class EnrollmentRepository implements IEnrollmentRepository {
  constructor(@InjectRepository(EnrollmentOrmEntity) private readonly repo: Repository<EnrollmentOrmEntity>) {}

  async findByStudentAndSubject(studentId: string, subjectId: string): Promise<EnrollmentEntity | null> {
  ...
  private toDomain = (o: EnrollmentOrmEntity): EnrollmentEntity =>
    new EnrollmentEntity(o.id, o.studentId, o.subjectId, o.status as EnrollmentStatus, o.enrolledAt, o.createdAt);

  private toOrm(d: EnrollmentEntity): EnrollmentOrmEntity {
    const o = new EnrollmentOrmEntity();
    o.id = d.id; o.studentId = d.studentId; o.subjectId = d.subjectId;
    o.status = d.status; o.enrolledAt = d.enrolledAt; o.createdAt = d.createdAt;
    return o;
  }
}
