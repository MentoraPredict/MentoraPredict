...
export class SubjectRepository implements ISubjectRepository {
  constructor(@InjectRepository(SubjectOrmEntity) private readonly repo: Repository<SubjectOrmEntity>) {}
  ...
  async findByPeriodId(periodId: string): Promise<SubjectEntity[]> {
    const list = await this.repo.find({ where: { periodId } });
  ...
  private toDomain = (o: SubjectOrmEntity): SubjectEntity =>
    new SubjectEntity(o.id, o.name, o.code, o.credits, o.periodId, o.teacherId, o.isActive, o.createdAt, o.updatedAt);

  private toOrm(d: SubjectEntity): SubjectOrmEntity {
    const o = new SubjectOrmEntity();
    o.id = d.id; o.name = d.name; o.code = d.code; o.credits = d.credits;
    o.periodId = d.periodId; o.teacherId = d.teacherId; o.isActive = d.isActive;
